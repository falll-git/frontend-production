...
const DokumenListModal = dynamic(
  () => import("@/components/arsip/DokumenListModal"),
  { ssr: false },
);
const LemariGridModal = dynamic(
  () => import("@/components/arsip/LemariGridModal"),
  { ssr: false },
);
const RakGridModal = dynamic(() => import("@/components/arsip/RakGridModal"), {
  ssr: false,
});
const StorageSummaryCard = dynamic(
  () => import("@/components/arsip/StorageSummaryCard"),
  { ssr: false },
);
...
export default function TempatPenyimpananPageClient() {
